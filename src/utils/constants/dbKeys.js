export const DB_KEYS = {
    //for mock lender-user map
    PAYMENT_CREATED: 'createdAt',
    PAYMENT_UPDATED: 'updatedAt',
    PAYMENT_STATUS: 'status',
    PAYMENT_LENDER_NAME: 'beneficiary_name',
    PAYMENT_LENDER_REFERENCE:'beneficiary_reference',
    PAYMENT_LENDER_ACCOUNT_NUMBER: 'beneficiary_account_number',
    FORM_LENDER_PAYMENT_REFERENCE: 'lenderPaymentReference',
    USER_ID_MAPPED : 'response.data.user_id',
    LENDER_LOGO : 'response.data[0].beneficiary_logo',
    REMITTER_REFERECNE :'response.data[0].remitter_reference',
    LENDER_ACCOUNT_NUMBER : 'response.data[0].beneficiary_contact_number',
    LENDER_NAME : 'response.data[0].beneficiary_name',
    LENDER_ADDITIONAL_DETAILS :'response.data[0].beneficiary_additional_details',
    LENDER_CONTACT_NUMBER : 'response.data[0].beneficiary_contact_number',
    LENDER_REFERENCE: 'response.data[0].beneficiary_reference',
    LENDER_ID: 'response.data[0].id',
    LENDER_BENEFICIARY_ID: 'response.data[0].beneficiary_id',
    BENEFICIARY_ADDITIONAL_DETAILS: 'beneficiary_additional_details',
    BENEFICIARY_LOGO: 'beneficiary_logo',
    BENEFICIARY_NAME: 'beneficiary_name',
    FORM_EMAIL: 'logIn.values.email',
    BENEFICIARY_ID: 'id',
    EMAIL : 'data.email',
    MORTGAGE_INPUT_VALUES : 'MortgageInput.values',
    // UDER_ID_FROM_GOAL : 'response.data[0].user_id',
    RESPONSE : 'response',
    DATA: 'response.data',
    ...
    EMAIL_AUTH_ACCESS_DATA_TOKEN : 'response.data.token.accessToken',
    ...
    UPCOMING_PAYMENT_DATE_REMINDER_DAYS: 'response.data.snooze_period',
    ...
    MORTGAGE_LAST_UPDATED_AT: 'response.data[0].updatedAt',
    MORTGAGE_TERM: 'response.data[0].mortgage_term',
    OLD_MORTGAGE_TERM: 'response.data[0].old_mortgage_term',
    MORTGAGE_TERM_MONTHS: 'response.data[0].mortgage_term_months',
    ERROR: 'error',
    ...
    FORM_MORTGAGE_TIMEPERIOD_MONTHS: 'MortgageInput.values.timePeriodMonths',
    ...
    IS_ADDRESS_VERIFIED: 'response.response.data.errors.address_verified',
    PROJECTED: {
    ...
    INTRO_CAROUSEL: {
      ...
      TITLE: 'title',
      SUB_TITLE: 'subTitle',
      FIRST_SUB_TITLE1: 'firstSubTitle1',
      FIRST_SUB_TITLE2:'firstSubTitle2',
      FIRST_SUB_TITLE3: 'firstSubTitle3',
      FOURTH_CAROUSEL:'fourthCarousel',
    ...
    */
    ...
    SOCKET_RESPONSE : {
      DATA:'data[0]',
      PAYMENT_SOCKET_MESSAGE: {
        ERROR: 'socketMessage.error',
        IS_PAYMENT_DONE: 'socketMessage.isPaymentDone',
        PAYMENT_AMOUNT: 'socketMessage.paymentAmount',
        PAYMENT_STATUS:  'socketMessage.paymentStatus'
      }
    },
    LENDER_LIST: {
      LENDER_ID: 'id',
      LENDER_NAME: 'beneficiary_name',
      NO_BENEFICIARY_FOUND: 'No Lender Found!'
    },
    SELECTED_LENDER: {
      SELECTED_LENDER_ID: 'selectedLender.values.id',
      SELECTED_LENDER_NAME: 'selectedLender.values.beneficiary_name'
    },
    BACKEND_HEALTH: {
      HEALTH_CHECK: 'response.data.healthcheck.message'
    }
  };
